...
class BetterGCNConv(MessagePassing):
    # ...
    def __init__(self, nodes_channels, edge_channels, message_channels):
        super().__init__(aggr='add')  # "Add" aggregation (Step 5).
        self.mlp1 = Seq(Linear(nodes_channels + edge_channels, message_channels),
                       ReLU(),
                       Linear(message_channels, message_channels))

        self.mlp2 = Seq(Linear(message_channels + nodes_channels, nodes_channels),
                       ReLU(),
                       Linear(nodes_channels, nodes_channels))
